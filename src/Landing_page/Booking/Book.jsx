...
function Book() {
  return (
    <div className='book'>
      <span className="book-tag">Hassle-Free Booking</span>
      <h1>Embark on Your Dream Journey</h1>
      <p className="book-intro">
        Choose your destination, pick your dates, and let us handle everything else. We craft stress-free, memorable experiences for every traveler.
      </p>
      <div className="book-features">
        <div className="book-feature">
          ...
          <div>
            ...
            <p>Travel on your schedule with flexible booking options</p>
          </div>
        </div>
        <div className="book-feature">
          <span className="book-feature-icon">✦</span>
          <div>
            ...
            <p>Cancel anytime before your trip with no charges</p>
          </div>
        </div>
        <div className="book-feature">
          <span className="book-feature-icon">✦</span>
          <div>
            <h4>Halal Meals Included</h4>
            <p>Fully halal food options guaranteed on every tour</p>
          </div>
        </div>
        <div className="book-feature">
          <span className="book-feature-icon">✦</span>
